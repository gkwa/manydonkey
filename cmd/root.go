...
import (
	...
	"github.com/gkwa/manydonkey/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.manydonkey.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".manydonkey")
	}
